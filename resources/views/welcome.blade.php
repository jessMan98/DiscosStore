...
<link rel="stylesheet" type="text/css" href="MusicStyle/OwlCarousel2-2.3.4/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="MusicStyle/OwlCarousel2-2.3.4/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="MusicStyle/OwlCarousel2-2.3.4/animate.css">
<link rel="stylesheet" type="text/css" href="MusicStyle/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="MusicStyle/styles/responsive.css">
</head>
                    ...
                    <div class="header_content d-flex flex-row align-items-center justify-content-center">
                        ...
                        <nav class="main_nav">
                            <ul class="d-flex flex-row align-items-center justify-content-start">
                                <li class="active"><a href= "{{ route('casa') }}">Home</a></li>
                                <li><a href="#">Artists</a></li>
                                <li><a href="#">Download Music</a></li>
                                <li><a href="#">Hola miamor</a></li>
            ...
            <div class="menu_content d-flex flex-column align-items-center justify-content-start">
                <nav class="menu_nav">
                    <ul class="d-flex flex-column align-items-center justify-content-start">
                        <li><a href="#">Hola perro</a></li>
                        <li><a href="Music.artists">Artists</a></li>
                        <li><a href="#"> Download Music</a></li>
                        <li><a href="Music.blog"> Administra </a></li>
                        <li><a href="Music.contact">Contact</a></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="home">
        ...
        <div class="home_slider_container">
            <div class="owl-carousel owl-theme home_slider">
                ...
                <!-- Slide -->
                <div class="slide">
                    <div class="background_image" style="background-image:url(MusicStyle.images/index.jpg)"></div>
    ...
    <div class="news">
        <div class="container">
            ...
            <div class="row news_row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="news_post image_top">
                        <div class="news_post_image"><img src="MusicStyle/images/news_3.jpg" alt=""></div>
                        <div class="news_post_content">
                            <div class="news_post_date"><a href="#">Oct 19, 2018</a></div>
...
<script src="MusicStyle/plugins/greensock/TweenMax.min.js"></script>
<script src="MusicStyle/plugins/greensock/TimelineMax.min.js"></script>
<script src="MusicStyle/plugins/scrollmagic/ScrollMagic.min.js"></script>
<script src="MusicStyle/plugins/greensock/animation.gsap.min.js"></script>
<script src="MusicStyle/plugins/greensock/ScrollToPlugin.min.js"></script>
<script src="MusicStyle/plugins/OwlCarousel2-2.3.4/owl.carousel.js"></script>
<script src="MusicStyle/plugins/jPlayer/jquery.jplayer.min.js"></script>
<script src="MusicStyle/plugins/jPlayer/jplayer.playlist.min.js"></script>
<script src="MusicStyle/plugins/easing/easing.js"></script>
<script src="MusicStyle/plugins/progressbar/progressbar.min.js"></script>
<script src="MusicStyle/plugins/parallax-js-master/parallax.min.js"></script>
<script src="MusicStyle/plugins/scrollTo/jquery.scrollTo.min.js"></script>
<script src="MusicStyle/js/custom.js"></script>
